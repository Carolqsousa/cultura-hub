...
export default function OverviewPage() {
  ...
  // unique professors and branches for dropdowns
  ...
  }, [teachers, filterProf, filterStatus, filterBranch]);
    ...
    <main className="p-6">
      ...
      <div className="bg-white rounded-xl border p-5 mb-6">
        <div className="flex items-center justify-between mb-4 flex-wrap gap-3">
          ...
          <div className="flex gap-2 flex-wrap">
            ...
            >
              ...
              {professors.filter(p => p !== "all").map(p => (
        ...
        {filteredTeachers.length === 0
          ? <p className="text-sm text-gray-400 py-4 text-center">Nenhum professor encontrado com esse filtro.</p>
          : (
            <table className="w-full text-sm">
              <thead>
                <tr className="text-left text-gray-400 border-b">
                    ...
                    <tr key={i} className="border-b last:border-0">
                      ...
                      <td className="py-2">
                        <div className="flex items-center gap-2">
                          ...
                          <span style={{color:p===100?"#1D9E75":p>=70?"#BA7517":"#A32D2D"}} className="text-xs font-medium min-w-[34px] text-right">{p}%</span>
                        </div>
                      </td>
                      <td className="py-2">
                        {p === 100
